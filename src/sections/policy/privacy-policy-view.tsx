...
const PrivacyPolicy = () => {
  ...
  return (
    <MotionContainer>
      <Box
        sx={{ padding: { xs: 2, md: 4 }, maxWidth: '800px', margin: 'auto' }}
      >
        ...
        <m.div variants={varBounce().in}>
          <Typography
            paragraph
            sx={{ textIndent: '20px', lineHeight: 1.6, mt: 2 }}
          >
            ...
            dijelimo vaše osobne podatke prilikom korištenja aplikacije Vatreni
            Put.
          </Typography>
        </m.div>
        ...
        <m.div variants={varBounce().in}>
          <Typography
            paragraph
            sx={{ textIndent: '20px', lineHeight: 1.6 }}
          >
        ...
        <m.div variants={varBounce().in}>
          ...
          >
            ...
            kakvih pitanja ili zahtjeva vezanih za vaše osobne podatke, molimo
            vas da se obratite na [email adresa za kontakt].
          </Typography>
        </m.div>
        ...
        <m.div variants={varBounce().in}>
          ...
          >
            ...
            politikom privatnosti, molimo kontaktirajte Digisence Agency na
