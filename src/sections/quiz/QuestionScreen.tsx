...
const QuestionScreen = ({
    ...
    return (
        <Grid container spacing={2} direction="column" alignItems={'center'} justifyContent="center" m={0} maxWidth={'500px'}>
            <Grid container direction="column" alignItems="center" spacing={1}>
                <Grid item width={'100%'} padding={0}>
                    <Grid container alignItems="center">
                        <Grid item>
                            <IconButton edge="start" color="primary" aria-label="back to dashboard" onClick={(e: any) => {
                                e.preventDefault();
                                setShowModal(true)
                            }}>
                                <ArrowBackIcon />
