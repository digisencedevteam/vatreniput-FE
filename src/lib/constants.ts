  ...
  },
  {
    ...
    story: {
      ...
      Prvenstvo: {
        ...
        Summary:
          'Pognutih glava igrači Ante Čačića napustili su Francusku. A tako je malo nedostajalo za veliki rezultat. Hrvatska je igrala jako dobro. Dizala se kroz turnir. Prva, teška pobjeda nad Turskom golom Luke Modrića podsjetila je na slavlje iz 1996. nad istim protivnikom. Češka je također bila nadigrana, ali nakon prekida zbog bakljade, šokirani Vatreni uzeli su samo bod.',
        Champ: {
          Winner: 'PORTUGAL',
          TopScorer: {
